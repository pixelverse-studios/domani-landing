...
| --- | --- | --- |
| **Planning window** | Morning-first (daily planning ritual at start of day) | Evening-first with Plan Lock |
| **Task limit** | No built-in limit (manual discipline) | Built-in 3-6 task guardrails |
| **Energy tagging** | Not available | Energy-aware scheduling with high/medium/low tags |
| **Decision fatigue protection** | None (you replan every morning) | Plan Lock prevents morning second-guessing |
| **Integrations** | Extensive (Asana, Trello, Gmail, Slack, Todoist, Notion, etc.) | Focused (Calendar sync, future integrations planned) |
| **Calendar view** | Full time-blocking calendar | Streamlined daily view with energy-based ordering |
...
- **Plan Lock.** You can't accidentally replan your morning in a moment of doubt. Once locked, the plan holds.
...
2. **Import your recurring tasks.** Move your regular commitments into Domani so you're not rebuilding from scratch.
...
4. **Set the Plan Lock reminder** for 30 minutes before you usually log off. This becomes the trigger for your new [evening planning routine](/blog/evening-planning-routine).
