...
If you want an app built specifically for this workflow, [Domani](/) is live on iOS and Android. Evening planning, task rollover, task limits, and streak tracking — nothing more, nothing less. You can also see our [full comparison page](/compare/ticktick) for a detailed feature-by-feature breakdown.
