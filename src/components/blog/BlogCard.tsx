...
export function BlogCard({ post }: BlogCardProps) {
  return (
    <article className="group overflow-hidden rounded-3xl border border-gray-100 bg-white/70 shadow-lg shadow-primary-500/5 backdrop-blur transition hover:-translate-y-1 hover:shadow-primary-500/20">
