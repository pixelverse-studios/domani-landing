...
export default function HeroSection({
  ...
  return (
    <section
      className="relative flex min-h-screen items-center justify-center overflow-clip bg-gradient-to-b from-white via-primary-50/30 to-primary-50/10"
      aria-label="Hero section"
    >
      <div className="absolute inset-0 -z-10 overflow-hidden">
        <div className="absolute top-0 left-0 h-72 w-72 rounded-full bg-primary-300 opacity-20 blur-xl mix-blend-multiply " />
        <div className="absolute top-0 right-0 h-72 w-72 rounded-full bg-primary-300 opacity-20 blur-xl mix-blend-multiply " />
        <div className="absolute -bottom-32 left-20 h-96 w-96 rounded-full bg-primary-200 opacity-15 blur-2xl mix-blend-multiply " />
        <div className="absolute -bottom-48 right-32 h-80 w-80 rounded-full bg-primary-200 opacity-10 blur-2xl mix-blend-multiply " />
        <HeroMotionLayer />
      </div>
      ...
      <div className="container mx-auto px-4 pb-16 pt-20 sm:px-6 md:pb-20 md:pt-24 lg:px-8">
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
          <div className="text-left">
            <span
              data-hero-motion
              className="inline-block rounded-full bg-green-100 px-4 py-2 text-sm font-semibold text-green-700 "
            >
              {getCurrentBadgeText()}
            </span>
            ...
            <div
              data-hero-motion
              className="mt-8 flex flex-col items-start gap-3 text-sm text-gray-600 "
            >
          ...
          <div data-hero-motion className="relative lg:pl-8">
            <div className="relative mx-auto max-w-md lg:max-w-none">
              ...
              <div className="relative overflow-hidden rounded-3xl bg-white shadow-[0_4px_8px_rgba(0,0,0,0.12),0_8px_24px_rgba(0,0,0,0.08),0_16px_48px_rgba(0,0,0,0.04)] transition-shadow duration-300 hover:shadow-[0_8px_16px_rgba(0,0,0,0.15),0_16px_32px_rgba(0,0,0,0.1),0_24px_56px_rgba(0,0,0,0.05)] ">
                ...
                <div className="min-h-[500px] bg-gradient-to-b from-primary-50 to-white p-5 ">
                  {/* Planning for header with toggle */}
                  <div className="mb-4 flex items-center justify-between">
                    <span className="text-sm text-gray-500 ">Planning for</span>
                  ...
                  <div className="mb-4">
                    ...
                    <p className="text-sm text-gray-500 ">Tuesday, January 6th</p>
                  </div>
                  ...
                  <div className="mb-4 rounded-xl bg-white p-4 shadow-sm ">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="text-xs text-gray-500 ">Tasks Planned</p>
                  ...
                  <p className="mb-3 text-sm font-medium text-gray-500 ">Planned Tasks (4)</p>
                  ...
                  <div className="space-y-3">
                      ...
                      <div className="flex">
                        ...
                        <div className="flex flex-1 items-start justify-between p-3">
                          <div className="flex-1">
                            <p className="font-medium text-gray-900 ">Review quarterly report</p>
                    ...
                    <div className="overflow-hidden rounded-xl border border-gray-100 bg-white shadow-sm ">
                      <div className="flex">
                        ...
                        <div className="flex flex-1 items-start justify-between p-3">
                          <div className="flex-1">
                            <p className="font-medium text-gray-900 ">Morning yoga session</p>
                            <div className="mt-1.5 flex items-center gap-2">
                    ...
                    <div className="overflow-hidden rounded-xl border border-gray-100 bg-white shadow-sm ">
                      <div className="flex">
                        ...
                        <div className="flex flex-1 items-start justify-between p-3">
                          <div className="flex-1">
                            <p className="font-medium text-gray-900 ">Call mom</p>
                            <div className="mt-1.5 flex items-center gap-2">
                              <span className="rounded bg-orange-100 px-1.5 py-0.5 text-xs font-medium text-orange-700 ">
                                Medium
                              </span>
                    ...
                    <div className="overflow-hidden rounded-xl border border-gray-100 bg-white shadow-sm ">
                      <div className="flex">
                        ...
                        <div className="flex flex-1 items-start justify-between p-3">
                          <div className="flex-1">
                            <p className="font-medium text-gray-900 ">Read productivity book</p>
                            <div className="mt-1.5 flex items-center gap-2">
              ...
              <div className="absolute top-0 right-0 -translate-y-2 translate-x-2 rounded-xl bg-white p-3 shadow-lg ">
                <div className="flex items-center gap-2 text-sm">
                  <div className="flex h-8 w-8 items-center justify-center rounded-full bg-green-100 ">
                    <span className="font-bold text-green-600 ">4</span>
                  </div>
                  <span className="font-medium text-gray-700 ">Tasks Set</span>
                </div>
              </div>

              {/* Floating badge: Streak */}
              <div className="absolute bottom-0 left-0 -translate-x-2 translate-y-2 rounded-xl bg-white p-3 shadow-lg ">
                <div className="flex items-center gap-2 text-sm">
                  <span className="text-2xl">7</span>
                  <span className="font-medium text-gray-700 ">Day Streak</span>
                </div>
              </div>
            </div>
          </div>
