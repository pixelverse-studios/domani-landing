      ...
      <div className="flex flex-col sm:flex-row gap-3">
        ...
        >
          ...
          <div className="flex flex-col items-start">
            <span className={`${subtextSize} opacity-80 leading-none`}>on TestFlight</span>
            <span className={`${textSize} font-semibold leading-tight`}>Join Beta</span>
          </div>
        </motion.a>
        ...
        >
          ...
          <div className="flex flex-col items-start">
            <span className={`${subtextSize} opacity-80 leading-none`}>on Google Play</span>
            <span className={`${textSize} font-semibold leading-tight`}>Join Beta</span>
          </div>
        </motion.a>
      </div>
