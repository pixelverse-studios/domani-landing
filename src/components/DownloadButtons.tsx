      ...
      <div className="flex flex-col sm:flex-row gap-3">
        ...
        <motion.a
          ...
          className={`
            ...
            bg-gray-950 text-white rounded-xl
            hover:bg-gray-800 transition-colors duration-200
            shadow-lg hover:shadow-xl
          `}
          aria-label="Download Domani on the App Store"
        >
          {/* Apple Logo */}
          ...
          <div className="flex flex-col items-start">
            <span className={`${textSize} font-semibold leading-none`}>
              {APP_STORE_CONFIG.ios.ctaLabel}
            </span>
            <span className={`${subtextSize} opacity-90 leading-tight`}>
              {APP_STORE_CONFIG.ios.ctaSubtext}
            </span>
          </div>
        </motion.a>
        ...
        <motion.a
          ...
          className={`
            ...
            shadow-lg hover:shadow-xl
          `}
          aria-label="Get Domani on Google Play"
        >
          {/* Google Play Logo */}
          <svg className={iconSize} viewBox="0 0 24 24" fill="currentColor">
          ...
          <div className="flex flex-col items-start">
            <span className={`${textSize} font-semibold leading-none`}>
              {APP_STORE_CONFIG.android.ctaLabel}
            </span>
            <span className={`${subtextSize} opacity-90 leading-tight`}>
              {APP_STORE_CONFIG.android.ctaSubtext}
            </span>
          </div>
        </motion.a>
      </div>
