  ...
  return (
    <div className={cn('relative', className)}>
      ...
      >
          ...
          >
            ...
            {isMobile && showHomeIndicator && (
              <div className="absolute bottom-0 left-0 right-0 h-8 flex items-end justify-center pb-2">
                <div className="w-32 h-1 bg-gray-900 rounded-full opacity-30" />
              </div>
            )}
          </div>
        ...
        <div
          className={cn(
            'absolute inset-x-0 -bottom-px h-px bg-gradient-to-r from-transparent via-gray-300 to-transparent',
            'opacity-50'
          )}
        />
      </motion.div>
