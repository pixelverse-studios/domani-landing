...
export const alt = 'About Domani - Why Evening Planning Works'
    ...
    (
      ...
      >
        <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
          ...
          >
            Why Evening Planning Works Better
          </div>
          <div
            style={{
              fontSize: '22px',
          ...
          >
            The science behind planning tomorrow tonight and waking up ready to execute.
          </div>
        </div>
        <div
          style={{
