        ...
        <div className="mt-16 grid gap-6 lg:grid-cols-3">
          {featuredClusters.map((cluster) => (
            <Link
              ...
              className="rounded-3xl border border-primary-100/70 bg-white/70 p-6 shadow-lg transition hover:-translate-y-1 hover:border-primary-300 hover:shadow-primary-500/20"
            >
